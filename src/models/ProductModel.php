...
class ProductModel {
    ...
    public function getAll() {
        $query = "SELECT p.product_id as id, name_ as name, price, category, collection_id, image_path as image, quantity,collection_id, avg(r.score) as rating   FROM " . $this->tableName . " p inner join review r on p.product_id = r.product_id group by r.product_id
        UNION 
